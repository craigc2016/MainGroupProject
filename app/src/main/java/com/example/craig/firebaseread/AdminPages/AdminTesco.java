...
This class is for the handling of the aldi table of the application.
 ...
 the user.
 */
public class AdminTesco extends AppCompatActivity {
    /*
    ...
    private String key="";
    private ArrayList<Tesco> list;
    private String name = "";
    private String tempname="";
    private ArrayAdapter<Tesco> adapter;
    /*
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_addtesco);
        getIntent();
        setUpScreen();
        getTescoList();
    }
    ...
    public void getTescoList(){
        ...
        refTesco.orderByKey().addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Tesco item = dataSnapshot.getValue(Tesco.class);
    ...
    */
    public void addItem(){
        ...
        if(!addName.equals("")&& addPrice != 0.0 && !name.matches(addName)){
            ...
            Firebase newRef = ref.child("Tesco").push();
    ...
    public void editItem(){
         ...
         */
        Query query = refTesco.orderByChild("name");
        ...
        if(!key.equals("")){
            ...
            try {
                ...
                counterEdit = 1;    // return the user to the start of the life cycle
            }
             /*
            Used to check if the input name already exist in the table
            If so it will display a message and bring the user back to the start of the
        ...
        */
        if(!nameEdit.equals("") && priceEdit != 0.0 && !name.matches(nameEdit)){
            ...
            refTesco.child(key).setValue(item);
    ...
    /*
    Handles the button click for reloadAdmintesco option
     */
    public void reloadAdminTesco(){
        Intent in = new Intent(this,AdminTesco.class);
        startActivity(in);
        finish();
    }
