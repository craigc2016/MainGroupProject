...
This class is for the handling of the aldi table of the application.
 ...
 the user.
 */
public class AdminLidl extends AppCompatActivity {
    /*
    ...
    */
    ...
    private ArrayList<Lidl>list;
    private ArrayAdapter<Lidl> adapter;
    ...
    to the list view.
     */
    public void getLidlList(){
        list = new ArrayList<>();
        adapter = new ArrayAdapter<>(getBaseContext(),android.R.layout.simple_list_item_1, list);
        listView.setAdapter(adapter);
        refLidl.orderByKey().addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                Lidl item = dataSnapshot.getValue(Lidl.class);
    ...
    public void addItem(){
        ...
        if(!addName.equals("")&& addPrice != 0.0 && !name.matches(addName)){
            ...
            Firebase newRef = ref.child("Lidl").push();
    ...
    public void editItem(){
         ...
         */
        Query query = refLidl.orderByChild("name");
        ...
        */
        if(!nameEdit.equals("") && priceEdit != 0.0 && !name.matches(nameEdit)){
            ...
            refLidl.child(key).setValue(item);
    ...
    /*
    Handles the button click for reloadAdminLidl option
     */
    public void reloadAdminLidl(){
        Intent in = new Intent(this,AdminLidl.class);
        startActivity(in);
        finish();
    }
